...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sub_menus: Schema.Attribute.Relation<'oneToMany', 'api::sub-menu.sub-menu'>;
...
export interface ApiSectionItemSectionItem extends Struct.CollectionTypeSchema {
  collectionName: 'section_items';
  info: {
    displayName: 'SectionItem';
    pluralName: 'section-items';
    singularName: 'section-item';
  };
  options: {
    draftAndPublish: true;
  };
